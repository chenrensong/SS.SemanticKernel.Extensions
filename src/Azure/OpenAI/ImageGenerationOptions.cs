...
{
    public class CoreImageGenerationOptions : ImageGenerationOptions
    {
        ...
        public CoreImageGenerationOptions()
        {
        }

        public CoreImageGenerationOptions(string prompt)
        {
            Azure.Core.Argument.AssertNotNull(prompt, "prompt");
            Prompt = prompt;
        }

        internal CoreImageGenerationOptions(string prompt, int? imageCount, ImageSize? size, ImageGenerationResponseFormat? responseFormat, string user)
        {
            Prompt = prompt;
        ...
        void Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName(new byte[4] { 115, 105, 122, 101 });
