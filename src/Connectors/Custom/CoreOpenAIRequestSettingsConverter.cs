...
/// <summary>
/// JSON converter for <see cref="CoreOpenAIRequestSettings"/>
/// </summary>
public class CoreOpenAIRequestSettingsConverter : JsonConverter<CoreOpenAIRequestSettings>
{
    /// <inheritdoc/>
    public override CoreOpenAIRequestSettings? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        var requestSettings = new CoreOpenAIRequestSettings();
            ...
            if (reader.TokenType == JsonTokenType.PropertyName)
            {
                ...
                switch (propertyName)
                {
                    ...
                    case "CHAT_SYSTEM_PROMPT":
                        requestSettings.ChatSystemPrompt = reader.GetString() ?? CoreOpenAIRequestSettings.DefaultChatSystemPrompt;
                        break;
    ...
    /// <inheritdoc/>
    public override void Write(Utf8JsonWriter writer, CoreOpenAIRequestSettings value, JsonSerializerOptions options)
    {
