...
public class ChatStreamingModelResult
{
    ...
    /// </summary>
    public CoreStreamingChatChoice Choice { get; }
    ...
    internal ChatStreamingModelResult(StreamingChatCompletions completionsData, CoreStreamingChatChoice choiceData)
    {
