...
public class OpenAIFunction
{
    ...
    /// <summary>
    /// Converts the <see cref="OpenAIFunction"/> to OpenAI's <see cref="CoreFunctionDefinition"/>.
    /// </summary>
    /// <returns>A <see cref="CoreFunctionDefinition"/> containing all the function information.</returns>
    public CoreFunctionDefinition ToFunctionDefinition()
    {
        JsonSchemaFunctionView jsonSchemaView = this.ToFunctionView().ToJsonSchemaFunctionView(GetJsonSchemaDocument, false);

        return new CoreFunctionDefinition
        {
